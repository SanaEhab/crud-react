    ...
    <div className="col py-3">
      {backError && <p className='text text-danger'>{backError}</p>}
        <form onSubmit={sendData}>
          <Input id={'username'} errors={errors} title={'User name'} name={'name'} type={'text'} customClass="border border-danger-subtle" handelData={handelData}/>
          <Input id={'email'} errors={errors} title={'Email address'} name={'email'} type={'email'} customClass="border border-danger-subtle" handelData={handelData}/>
          <Input id={'password'} errors={errors} title={'Password'} name={'password'} type={'password'} customClass="border border-danger-subtle" handelData={handelData}/>
            <div className="mb-3">
